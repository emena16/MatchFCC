    ...
    public function index()
    {
        ...
        if (empty($oUsers)) {
            Header::redirect(
                ...
                t('No hay resultados. Por favor, inténtelo de nuevo con criterios de búsqueda más amplios o nuevos.'),
                Design::WARNING_TYPE
            );
        } else {
            ...
            $this->view->h3_title = t('Encuentra nuevas personas %0%', '<span class="pH0">' . $this->registry->site_name . '</span>');
            $this->view->meta_description = t('Conoce nuevas personas y amigos cerca de ti con% site_name% - Browse Members');
