...
class ProfileController extends ProfileBaseController
{
    ...
    public function index()
    {
        ...
        if ($oUser && $this->doesProfileExist($oUser)) {
            ...
            $this->view->page_title = t('Conoce a %0%, A %1% Buscando %2% - %3% Años - %4% - %5% %6%',
    ...
    private function getMutualFriendLinkName()
    {
        ...
        $sMutFriendTxt = $iNbMutFriend <= 1 ? ($iNbMutFriend == 1) ? t('Amigos en Comun:') : t('No Mutual Friends') : t('Mutual Friends:');
